pro plot_sc2d, windx=windx, oname=oname
;
...
;
;for bstar
fname = 'sc2d/model2d.h5'
;
;-----------------------------------------------------------------------
;
read_sc2d, fname, ndxmax=ndxmax, ndzmax=ndzmax, xarr=x, zarr=z, opac2d=opac2d, scont2d=scont2d, t2d=t2d, nodes_nue=nodes_nue, nnue=nnue, epsmaxc_arr=epsmaxc_arr
...
scont2d=scont2d/bnue2d

contour_model2d, x, z, scont2d, zlim=[-.3d0,1.5d0], xlim=[-1.2,1.2], windx=windx
;
;-----------------------------------------------------------------------
;
plot_model2d, x, z, scont2d, opac2d, bnue2d, windx=windx
;
plot_convergence2d, epsmaxc_arr, windx=windx
...
;-----------------------------------------------------------------------
;
pro plot_model2d, x, z, scont2d, opac2d, bnue2d, xlim=xlim, windx=windx, oname=oname
;
...
;---------------------------------------------------------------------------
;
pro plot_convergence2d, epsmaxc_arr, windx=windx
;
if(not keyword_set(windx)) then windx=0
;
