pro tvellipse_jsmod, rmax, rmin, xc, yc, pos_ang, xout, yout, color, DATA = data, $
...
; JS_MOD: Added output x and y arrays xout, yout, insetad of
; plotting
 ...
 if N_params() LT 7 then pos_ang = 0.    ;Default position angle
 ...
 xout = xprime
 yout = yprime                          ;JS MOD: Added output 
