...
lines=['HEPS','HDELTA','HGAMMA','HBETA','HALPHA']
titles=['H_eps','H_delta','H_gamma','H_beta','H_alpha']

!p.multi=[0,2,3]
if !p.charsize eq 1. then !p.charsize=1.5

endif else begin
lines=['HGAMMA','HBETA','HALPHA']
titles=['H_gamma','H_beta','H_alpha']
!p.multi=[0,2,2]
endelse
