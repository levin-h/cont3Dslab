pro loadct_lev, ci_black, ci_blue, ci_red, ci_cyan, ci_green, ci_magenta, ci_yellow, ci_white, ci_dgreen=ci_dgreen, help=print_help
;+
; NAME:
;       loadct_lev
;
...
red=[0,0,0,255,255,0,255,255,0]
green=[0,0,255,0,255,255,0,255,150]
blue=[0,255,0,0,0,255,255,255,0]
color_name=['black','blue','green','red','yellow','cyan','magenta','white','dgreen']
