pro contour_slice3d, x, y, z, arr3d, velx3d, vely3d, velz3d, offset=offset, alpha=alpha, gamma=gamma, dvec=dvec, $
                   logscale=logscale, xlim=xlim, ylim=ylim, polar=polar, clim=clim, ovel=ovel, titlestr=titlestr, ctitlestr=ctitlestr, isoc=isoc, np=np, nzeta=nzeta
;
;----------------------------define range-------------------------------
;
...
contourplots_single2, arr2d, x_slice, y_slice, $
              ...
              ctable=13, ctitleStr=ctitleStr, /isotropic, /background2
;stop
;
