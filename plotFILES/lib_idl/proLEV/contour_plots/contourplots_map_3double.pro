pro contourplots_map_3double, arr2d_1, arr2d_2, arr2d_3, arr2d_4, arr2d_5, arr2d_6, $
...
;+
; NAME:
;       contourplots_map_3double
; PURPOSE:
;	This procedure creates six coloured contour-plots on a 3rowsx2cols grid, along with
;	a colorbar on the top, optimized for charsize=1.2 (ps-output with
;	xsize=17.8 cm) (A&A paper style).
;       
; CALLING SEQUENCE:
;	contourplots_map_3double, arr2d_1, arr2d_2, arr2d_3, arr2d_4, arr2d_5, arr2d_6, $
;                                 arrth_1, arrth_2, arrth_3, arrth_4, arrth_5, arrth_6, $
;                                 arrphi_1, arrphi_2, arrphi_3, arrphi_4, arrphi_5, arrphi_6, $
...
;
; EXAMPLE:
;       contourplots_map_3double, arr2d1, arr2d2, arr2d3, arr2d4, arr2d5, arr2d6, $
