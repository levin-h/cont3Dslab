pro contourplots_map_quad, arr2d_1, arr2d_2, arr2d_3, arr2d_4, $
                           arrphi_1, arrphi_2, arrphi_3, arrphi_4, $
                           arrth_1, arrth_2, arrth_3, arrth_4, $
...
; PURPOSE:
;	This procedure creates four coloured contour-plots in a 2x2 grid, along with
;	a colorbar on the top, optimized for charsize=1.2 (ps-output with
;	xsize=17.8 cm) (A&A paper style).
;       
; CALLING SEQUENCE:
;	contourplots_map_quad, arr2d_1, arr2d_2, arr2d_3, arr2d_4, $
;                              arrth_1, arrth_2, arrth_3, arrth_4, $
;                              arrphi_1, arrphi_2, arrphi_3, arrphi_4, $
...
;       arr2d_3:  2-dimensional array to be plotted as contour (lower left)
;       arr2d_4:  2-dimensional array to be plotted as contour (lower right)
...
;
; EXAMPLE:
;       CONTOURPLOTS_MAP_DOUBLE, arr2d1, arr2d2, arr2d3, arr2d4, $
;                                th1, th2, th3, th4, phi1, phi2, phi3, phi4, ncolors, $
...
if(keyword_set(print_help)) then begin
   doc_library, 'contourplots_map_quad'
   return
endif
;
;-----------------------------------------------------------------------
