...
if(keyword_set(xlim)) then begin
   ...
   xlim1=[min(arrx_1),max(arrx_1)]
   xlim2=[min(arrx_2),max(arrx_2)]
endelse
...
if(keyword_set(ylim)) then begin
   ...
   ylim1=[min(arry_1),max(arry_1)]
   ylim2=[min(arry_2),max(arry_2)]
endelse
;
;---------------------------first plot----------------------------------
;
...
if(keyword_set(background1)) then begin
   ...
   contour, bg_arr, [xlim1(0),xlim1(1)], [ylim1(0), ylim1(1)], $
            levels=[1.], $
            c_colors=[150], $
            xstyle=1, ystyle=1, $
...
if(keyword_set(background1)) then begin
   loadct, 0
;plot lower x-axis
   axis, xlim1(0), ylim1(0), xaxis=0, xrange=[xlim1(0),xlim1(1)], /xs, charsize=1.2
;plot upper x-axis (without labels)
   axis, xlim1(0), ylim1(1), xaxis=1, xrange=[xlim1(0),xlim1(1)], /xs, xtickformat='(A1)'
;plot left y-axis
   axis, xlim1(0), ylim1(0), yaxis=0, yrange=[ylim1(0),ylim1(1)], /ys, charsize=1.2
;plot right y-axis (without labels)
   axis, xlim1(1), ylim1(0), yaxis=1, yrange=[ylim1(0),ylim1(1)], /ys, ytickformat='(A1)'
endif
;
;---------------------------second plot---------------------------------
;
...
if(keyword_set(background1)) then begin
   loadct, 0
   bg_arr=1.d0+fltarr(2,2)*0.d0
   contour, bg_arr, [xlim2(0),xlim2(1)], [ylim2(0), ylim2(1)], $
            levels=[1.], $
            c_colors=[150], $
            xstyle=1, ystyle=1, $
            charsize=1., $       ;overall charsize (to set smaller title)
...
if(keyword_set(background1)) then begin
   loadct, 0
;plot lower x-axis
   axis, xlim2(0), ylim2(0), xaxis=0, xrange=[xlim2(0),xlim2(1)], /xs, charsize=1.2
;plot upper x-axis (without labels)
   axis, xlim2(0), ylim2(1), xaxis=1, xrange=[xlim2(0),xlim2(1)], /xs, xtickformat='(A1)'
;plot left y-axis
   axis, xlim2(0), ylim2(0), yaxis=0, yrange=[ylim2(0),ylim2(1)], /ys, charsize=1.2
;plot right y-axis (without labels)
   axis, xlim2(1), ylim2(0), yaxis=1, yrange=[ylim2(0),ylim2(1)], /ys, ytickformat='(A1)'
endif
;
;-----------------------------colorbar----------------------------------
;
