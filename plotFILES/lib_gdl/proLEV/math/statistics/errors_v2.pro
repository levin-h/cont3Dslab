pro errors_v2, sol3d, x, y, z, sol1d, r1d, erri, errm, err_max, devm, erri2=erri2, mask3d=mask3d, help=print_help
;
;+
; NAME:
;	errors
...
if(keyword_set(print_help)) then begin
   doc_library, 'errors_v2'
   return
endif

if(not keyword_set(mask3d)) then begin
   print, 'error in errors_v2: mask3d needs to be specified'
   doc_library, 'errors_v2'
   return
endif
;
...
;
         if(mask3d(i,j,k) eq 1 or mask3d(i,j,k) eq 2 or mask3d(i,j,k) eq 3) then begin
            xnum=sol3d(i,j,k)
