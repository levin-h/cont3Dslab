pro plotBFIELD_neg, windx=WINDX, nlines=NLINES, ralfven=RALFVEN, xlim=XLIM, ylim=YLIM, oplot=OPLOT, help=print_help
;
;+
; NAME:
;	plotBFIELD_neg
;
; PURPOSE:
;	This procedure plots magnetic dipole field lines on negative hemisphere
;
; CALLING SEQUENCE:
;
;	plotbfield_neg
